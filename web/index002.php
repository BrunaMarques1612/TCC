...
<section class="destaques_nossoAcervo book__header">
    <div class="book__header-bg"><img src="imagens/livros/Livro02.jpg" width="100%" height="100%" alt="Chapelzinho Vermelho"></div>
        ...
        <div class="book__header-content">
            ...
            <div class="book__header-info">
                <div class="book__thumb ">
                    <img src="imagens/livros/Livro02.jpg" alt="O Menino Maluquinho" width="100%" height="100%">
                </div>
                <div class="book__info">
                    ...
                    <p class="book__author"> Ziraldo </p>
                    <div class="book_textInfo">
                        ...
                        <div>
                            <p class="paragraph-space">
                                ...
                                <strong>ISBN: </strong> 9786555391916
                            </p>
                        </div>
                    </div>
