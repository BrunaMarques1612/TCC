...
<section class="destaques_nossoAcervo book__header">
    <div class="book__header-bg"><img src="imagens/livros/Livro05.jpg" width="100%" height="100%" alt="Percy Jackson - O Ladrão de raios"></div>
        ...
        <div class="book__header-content">
            ...
            <div class="book__header-info">
                <div class="book__thumb ">
                    <img src="imagens/livros/Livro05.jpg" alt="Percy Jackson - O Ladrão de raios" width="100%" height="100%">
                </div>
                    ...
                    <div class="book_textInfo">
                        ...
                        <div>
                            <p class="paragraph-space">
                                ...
                                <strong>ISBN: </strong> 9788580570151
                            </p>
                        </div>
                    </div>
