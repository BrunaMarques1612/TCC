...
<head>
    ...
    <title>Login Professor - Biblioteca Lino de Mattos</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/style.css">
</head>
<body class="pag-login-professor">
    <a href="login.php"><img id="voltar" src="img/login-professor/seta.png" alt="Voltar"></a>
    <form class="container-login-professor" action="entrada-login-professor.php" method="post">
        <div class="top-login">
            <img src="img/login-professor/user.png" alt="user-logo">
        ...
        <div class="footer-login">
           <a href="login-bibliotecario.php"><strong>Entrar como Bibliotecário</strong></a>
        </div>
    </form>
