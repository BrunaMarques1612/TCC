...
<section class="destaques_nossoAcervo book__header">
    <div class="book__header-bg"><img src="imagens/livros/Livro06w.jpg" width="100%" height="100%" alt="A invencao de hugo cabret"></div>
        ...
        <div class="book__header-content">
            ...
            <div class="book__header-info">
                <div class="book__thumb ">
                    <img src="imagens/livros/Livro06.jpg" alt="A invencao de hugo cabret" width="100%" height="100%">
                </div>
                <div class="book__info">
                    ...
                    <p class="book__author"> Brian Selznick, Marcos Magno </p>
                    <div class="book_textInfo">

                        <div class="book_textInfo-item">
                            <p class="paragraph-space">
                                <strong>Páginas:</strong> 533<br>
                                <strong>Editora:</strong> Ed. SM <br>
                        ...
                        <div>
                            <p class="paragraph-space">
                                ...
                                <strong>ISBN: </strong> 9788537810088
                            </p>
                        </div>
                    </div>
